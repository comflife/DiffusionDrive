...
python -m navsim.planning.script.run_training \
    ...
    +experiment_name=diffusiondrive_ar_step_corner_v2048_joint_v6_waymo \
    ...
    output_dir=/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v6_waymo \
    wandb.enabled=true \
    wandb.project="diffusiondrive-ar" \
    wandb.name="diffusiondrive_ar_step_corner_v2048_joint_v6_waymo" \
    "$@"
