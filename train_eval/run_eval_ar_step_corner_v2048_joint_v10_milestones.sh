...
#         ego cross-attn ON, BEV pos enc ON, warm-start) + ar_num_layers=12.
...
echo "=================================================="
echo "Evaluating DiffusionDrive-AR joint_v10 milestones (bev_first ordering, ar_num_layers=12)"
