#!/bin/bash
# Evaluate DiffusionDrive-AR joint_v7_scratch milestone checkpoints and print PDMS.
# v7_scratch = v7 architecture (single-call agent attention, deformable BEV ON,
#       ego cross-attn ON, BEV pos enc ON) but trained from scratch — NO 88.1
...
CKPT_DIR="${CKPT_DIR:-/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v7_scratch/checkpoints}"
EVAL_ROOT="${EVAL_ROOT:-/data2/byounggun/diffusiondrive_ar_output/eval_step_corner_v2048_joint_v7_scratch_milestones}"
...
echo "=================================================="
echo "Evaluating DiffusionDrive-AR joint_v7_scratch milestones"
...
run_eval_one() {
    ...
    local hydra_ckpt="/tmp/diffusiondrive_ar_step_corner_v2048_joint_v7_scratch_epoch_${epoch_tag}.ckpt"
    ...
    python3 -m navsim.planning.script.run_pdm_score \
        ...
        experiment_name="diffusiondrive_ar_step_corner_v2048_joint_v7_scratch_eval_epoch_${epoch_tag}" \
        output_dir="$out_dir"
