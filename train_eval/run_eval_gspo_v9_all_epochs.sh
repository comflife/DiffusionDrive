...
CKPT_DIR="${CKPT_DIR:-/data2/byounggun/diffusiondrive_gspo_output_v9/checkpoints}"
EVAL_ROOT="${EVAL_ROOT:-/data2/byounggun/diffusiondrive_gspo_output_v9/eval_all_epochs}"
...
echo "=================================================="
echo "Evaluating GSPO v9 — ALL epochs"
...
run_eval_one() {
    ...
    local hydra_ckpt="/tmp/gspo_v9_epoch_${epoch_tag}.ckpt"
    ...
    python3 -m navsim.planning.script.run_pdm_score \
        ...
        experiment_name="gspo_v9_eval_epoch_${epoch_tag}" \
        output_dir="$out_dir"
