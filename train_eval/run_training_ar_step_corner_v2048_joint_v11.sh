...
echo "Starting DiffusionDrive-AR step-corner v2048 JOINT v11 (bev_first ordering)..."
...
python -m navsim.planning.script.run_training \
    ...
    +experiment_name=diffusiondrive_ar_step_corner_v2048_joint_v11  \
    ...
    output_dir=/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v11 \
    wandb.enabled=true \
    wandb.project="diffusiondrive-ar" \
    wandb.name="diffusiondrive_ar_step_corner_v2048_joint_v11" \
    "$@"
