...
export RL_NAME="${RL_NAME:-grpo_10ep}"
export EVAL_LABEL="${EVAL_LABEL:-GRPO v6_waymo epoch120 10ep}"
export RL_DIR="${GRPO_V6_WAYMO_10EP_DIR:-${GRPO_DIR:-${RL_DIR:-/data2/byounggun/diffusiondrive_grpo_output_v6_waymo_epoch120_10ep}}}"
export GPUS="0"
