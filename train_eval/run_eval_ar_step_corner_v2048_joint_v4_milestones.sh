#!/bin/bash
# Evaluate DiffusionDrive-AR joint_v4 milestone checkpoints and print PDMS.
# v4 differs from v3 in that per-layer ego cross-attn is ON.
# Defaults to epoch 80, 90, ..., 120 (training currently around epoch 122).
# Override via START_EPOCH / END_EPOCH / EPOCH_STEP. Missing checkpoints fail
# the script unless SKIP_MISSING=1 is set.
...
CKPT_DIR="${CKPT_DIR:-/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v4/checkpoints}"
EVAL_ROOT="${EVAL_ROOT:-/data2/byounggun/diffusiondrive_ar_output/eval_step_corner_v2048_joint_v4_milestones}"
...
echo "=================================================="
echo "Evaluating DiffusionDrive-AR joint_v4 milestones"
...
run_eval_one() {
    ...
    local hydra_ckpt="/tmp/diffusiondrive_ar_step_corner_v2048_joint_v4_epoch_${epoch_tag}.ckpt"
    ...
    python3 -m navsim.planning.script.run_pdm_score \
        ...
        experiment_name="diffusiondrive_ar_step_corner_v2048_joint_v4_eval_epoch_${epoch_tag}" \
        output_dir="$out_dir"
