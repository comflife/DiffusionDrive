...
CKPT_DIR="${CKPT_DIR:-/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v6/checkpoints}"
EVAL_ROOT="${EVAL_ROOT:-/data2/byounggun/diffusiondrive_ar_output/eval_step_corner_v2048_joint_v6_milestones}"
...
echo "=================================================="
echo "Evaluating DiffusionDrive-AR joint_v6 milestones"
...
run_eval_one() {
    ...
    local hydra_ckpt="/tmp/diffusiondrive_ar_step_corner_v2048_joint_v6_epoch_${epoch_tag}.ckpt"
    ...
    python3 -m navsim.planning.script.run_pdm_score \
        ...
        experiment_name="diffusiondrive_ar_step_corner_v2048_joint_v6_eval_epoch_${epoch_tag}" \
        output_dir="$out_dir"
