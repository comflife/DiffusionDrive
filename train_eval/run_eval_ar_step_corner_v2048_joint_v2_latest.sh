#!/bin/bash
# Evaluate the joint_v2 (step_corners v2048, low trunk lr) AR model.
# Default ckpt: last.ckpt — override AR_CKPT to pick another epoch.
...
CKPT_DIR=/data2/byounggun/diffusiondrive_ar_output/step_corner_v2048_joint_v2/checkpoints
AR_CKPT="${AR_CKPT:-$CKPT_DIR/last.ckpt}"
...
HYDRA_CKPT=/tmp/diffusiondrive_ar_step_corner_v2048_joint_v2_eval.ckpt
ln -sfn "$AR_CKPT" "$HYDRA_CKPT"

echo "=================================================="
echo "Evaluating DiffusionDrive-AR joint_v2 (step_corners v2048, low trunk lr)"
echo "Source ckpt : $AR_CKPT"
echo "Hydra alias : $HYDRA_CKPT"
echo "GPU         : $CUDA_VISIBLE_DEVICES"
echo "Output      : /data2/byounggun/diffusiondrive_ar_output/eval_step_corner_v2048_joint_v2_latest"
echo "=================================================="
...
python3 -m navsim.planning.script.run_pdm_score \
    ...
    experiment_name=diffusiondrive_ar_step_corner_v2048_joint_v2_eval \
    output_dir=/data2/byounggun/diffusiondrive_ar_output/eval_step_corner_v2048_joint_v2_latest
