...
export RL_NAME="${RL_NAME:-gspo_10ep}"
export EVAL_LABEL="${EVAL_LABEL:-GSPO v6_waymo epoch120 10ep}"
export RL_DIR="${GSPO_V6_WAYMO_10EP_DIR:-${GSPO_DIR:-${RL_DIR:-/data2/byounggun/diffusiondrive_gspo_output_v6_waymo_epoch120_10ep}}}"
export GPUS="1"
