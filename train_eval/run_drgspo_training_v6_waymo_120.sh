#!/bin/bash
# Dr. GSPO fine-tuning on top of the v6_waymo SFT checkpoint at epoch 120,
# using the same NoRD-style recipe as run_drgspo_training_v6.sh.
#
# Base:
...
#
# Usage:
#   bash train_eval/run_drgspo_training_v6_waymo_120.sh
#   DEVICES=2 ACCUMULATE_GRAD_BATCHES=8 bash train_eval/run_drgspo_training_v6_waymo_120.sh
#   BASE_CKPT=/path/to/ckpt.ckpt bash train_eval/run_drgspo_training_v6_waymo_120.sh
#   RESUME_CKPT=none bash train_eval/run_drgspo_training_v6_waymo_120.sh  # fresh run
...
SAFE_CKPT="/tmp/drgspo_v6_waymo_epoch120_base_$(date +%s).ckpt"
...
OUTPUT_DIR="${OUTPUT_DIR:-/data2/byounggun/diffusiondrive_dr_gspo_output_v6_waymo_epoch120}"
...
if [ -n "$RESUME_CKPT" ]; then
    ...
    RESUME_SAFE_CKPT="/tmp/drgspo_v6_waymo_epoch120_resume_$(date +%s).ckpt"
...
echo "=================================================="
echo "DiffusionDrive-AR Dr. GSPO Fine-tuning (v6_waymo epoch-120 base)"
echo "=================================================="
...
python3 -m navsim.agents.diffusiondrive.grpo_train \
    ...
    ++experiment_name=diffusiondrive_ar_drgspo_v6_waymo_epoch120 \
    ...
    wandb.name="drgspo_v6_waymo_ep120_g${GROUP_SIZE}_t${TEMPERATURE}_lr${LR}_acc${ACCUMULATE_GRAD_BATCHES}" \
    "$@"

echo "=================================================="
echo "Dr. GSPO Training Complete (v6_waymo epoch-120)! Output: $OUTPUT_DIR"
echo "=================================================="
