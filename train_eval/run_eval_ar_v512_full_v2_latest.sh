#!/bin/bash
# Evaluate the v2 (joint-trained, NO freeze) AR model.
# Default ckpt: latest epoch_NN.ckpt under v512_full_v2/checkpoints/.
...
CKPT_DIR=/data2/byounggun/diffusiondrive_ar_output/v512_full_v2/checkpoints
...
HYDRA_CKPT=/tmp/diffusiondrive_ar_v512_full_v2_eval.ckpt
ln -sfn "$AR_CKPT" "$HYDRA_CKPT"

echo "=================================================="
echo "Evaluating DiffusionDrive-AR v2 (v512, no freeze)"
echo "Source ckpt : $AR_CKPT"
echo "Hydra alias : $HYDRA_CKPT"
echo "GPU         : $CUDA_VISIBLE_DEVICES"
echo "Output      : /data2/byounggun/diffusiondrive_ar_output/eval_v512_full_v2_latest"
echo "=================================================="
...
python3 -m navsim.planning.script.run_pdm_score \
    ...
    experiment_name=diffusiondrive_ar_v512_full_v2_eval \
    output_dir=/data2/byounggun/diffusiondrive_ar_output/eval_v512_full_v2_latest
