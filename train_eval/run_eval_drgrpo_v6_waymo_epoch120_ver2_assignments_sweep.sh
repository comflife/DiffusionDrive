...
export RL_NAME="${RL_NAME:-drgrpo_ver2_assignment_scenes}"
export EVAL_LABEL="${EVAL_LABEL:-Dr. GRPO v6_waymo epoch120 ver2 assignment scenes}"
export RL_DIR="${DRGRPO_V6_WAYMO_VER2_ASSIGNMENT_DIR:-/data2/byounggun/diffusiondrive_drgrpo_output_v6_waymo_epoch120_ver2_assignment_scenes}"
