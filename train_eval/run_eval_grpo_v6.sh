#!/bin/bash
# Eval a v6-style GRPO checkpoint with PDM scoring on navtest.
#
# Picks up the latest GRPO ckpt from the v6 output dir by default.
# Override via env: GRPO_CKPT=/path/to/ckpt.ckpt ./run_eval_grpo_v6.sh
...
echo "=================================================="
echo "Evaluating GRPO v6 checkpoint"
echo "=================================================="
...
python3 -m navsim.planning.script.run_pdm_score \
    ...
    experiment_name=diffusiondrive_grpo_v6_eval \
