#!/bin/bash
# Sweep eval for Dr. GRPO+ train-split assignment scenes (epochs 20,25,30,35,39)
...
echo "Evaluating on train-split assignment scene tokens (count: ${ASSIGNMENT_TOKEN_OUTPUT%% *})"

export RL_NAME="${RL_NAME:-drgrpo_plus_ver2_train_assignment_scenes}"
export EVAL_LABEL="${EVAL_LABEL:-Dr. GRPO+ v6_waymo epoch120 ver2 train assignment scenes}"
export RL_DIR="${DRGRPO_PLUS_V6_WAYMO_VER2_TRAIN_ASSIGNMENT_DIR:-/data2/byounggun/diffusiondrive_drgrpo_plus_output_v6_waymo_epoch120_ver2_train_assignment_scenes}"
