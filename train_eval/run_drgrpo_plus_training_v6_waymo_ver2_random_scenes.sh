...
export OUTPUT_DIR="${OUTPUT_DIR:-/data2/byounggun/diffusiondrive_drgrpo_plus_output_v6_waymo_epoch120_ver2_random_scenes}"
...
exec "$SCRIPT_DIR/run_drgrpo_plus_training_v6_waymo_ver2.sh" \
    ...
    ++experiment_name=diffusiondrive_ar_drgrpo_plus_v6_waymo_epoch120_ver2_random_scenes \
    "wandb.name=drgrpo_plus_v6_waymo_ep120_ver2_random_scenes_g${GROUP_SIZE:-12}_lr${LR:-1e-5}_clip${CLIP_EPS:-0.25}_acc${ACCUMULATE_GRAD_BATCHES:-8}" \
    "$@"