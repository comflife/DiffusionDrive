...
#
# Usage:
#   bash train_eval/run_drgrpo_plus_training_v6_waymo_ver2_val.sh
#   DEVICES=1 bash train_eval/run_drgrpo_plus_training_v6_waymo_ver2_val.sh
#   Run val experiments in parallel (one GPU each):
#     CUDA_VISIBLE_DEVICES=0 bash train_eval/run_drgrpo_plus_training_v6_waymo_ver2_val.sh
#     CUDA_VISIBLE_DEVICES=1 bash train_eval/run_drgrpo_plus_training_v6_waymo_ver2_val_assignments.sh
#     CUDA_VISIBLE_DEVICES=2 bash train_eval/run_drgrpo_plus_training_v6_waymo_ver2_val_assign_plus_random_scenes.sh
