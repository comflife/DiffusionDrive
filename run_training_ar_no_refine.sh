#!/bin/bash
# Train DiffusionDrive-AR without residual delta / heading refinement heads.
...
echo "Starting DiffusionDrive-AR no-refine ablation training..."
...
echo "Decoder: discrete AR with token-only XY and derived heading"
...
python -m navsim.planning.script.run_training \
    ...
    +experiment_name=diffusiondrive_ar_no_refine_v512 \
    ...
    wandb.name="diffusiondrive_ar_no_refine_v512"
