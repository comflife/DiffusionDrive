"""
Create action codebook from NavSim val data.

NavSim log format (validation set)
-----------------
Each .pkl file under  ``navsim_logs/private_test_hard/``  is a list of frame dicts
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path", type=str,
        default="/data/navsim/dataset/navsim_logs/private_test_hard",
        help="Root directory of NavSim log pkl files",
    )
    parser.add_argument(
        "--out_file_name", type=str,
        default="agent_vocab_navsim_kdisk_val.pkl",
